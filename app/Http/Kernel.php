...
use App\Http\Middleware\UserManagement;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        "admin_area" => AdminArea::class,
        "user_mgmt" => UserManagement::class,
        "backend_mgmt" => BackendManagement::class,
        "pwd_expired" => PasswordExpired::class,
